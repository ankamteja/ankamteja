...
```yaml
# -------- charan@ankamteja ---------
OS: ......... Kali, Fedora 43, Win 11
Uptime: ............ 19 y, 5 mo, 14 d
Host: ............ Amrita Vishwa, CBE
Kernel: .......... Offensive Security
Shell: .................... bash, zsh
IDE: ................... VS Code, vim

Lang.Code: ........ Python, C++, Java
Lang.Web: ........... HTML, CSS, YAML
Lang.Real: ... English, Telugu, Hindi

Hobbies: ....... CTFs, HTB, Write-Ups
Learning: ....... DSA, ML, Networking
Certs.WIP: ........... HTB CPTS, CCNA
Toolkit: ....... Burp, Wireshark, MSF
...
| **[pe-malware-detection](https://github.com/ankamteja/pe-malware-detection)** | Binary **Benign vs Malware** classification of Windows PE executables from 77 static header and import-table features (21.7k de-duplicated samples across 26 malware families). Random Forest with SMOTE balancing — **0.992 F1** on a held-out test set — evaluated with confusion matrix, ROC/PR curves, and feature importance. Jupyter. |
| **[CyberStegoApp](https://github.com/ankamteja/CyberStegoApp)** | Android steganography app that hides messages inside images via LSB. Payload sealed with authenticated **AES-256-GCM** (PBKDF2 key derivation, per-message salt + IV, tamper detection); account passwords stored as salted PBKDF2 hashes. Room session store, shake-to-logout. Java. |

### In Progress

| Repository | Focus & Technical Stack |
| :--- | :--- |
| **[ad-dmsa-privilege-escalation-lab](https://github.com/Hemashankar19/ad-dmsa-privilege-escalation-lab)** | Detection lab for the **"BadSuccessor"** dMSA privilege-escalation family in Windows Server 2025 Active Directory. Reproduces the attack chain in an isolated lab and builds the missing detection content — **Sigma / Wazuh / Splunk** rules plus a PowerShell exposure-enumeration script. Defensive research, built jointly with [@Hemashankar19](https://github.com/Hemashankar19). |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/ankam-charan-teja-41b11a320)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/ankamteja)
